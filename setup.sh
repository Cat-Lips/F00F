...
###  - Use --copy to commit and fix version               ###
#############################################################


externals=(
  #"https://github.com/Heavenlode/Nebula.git addons/Nebula --copy"
  #"https://github.com/Cat-Lips/F00F.EOS.SDK.NET.git addons/EOS.SDK.NET"
  #"https://github.com/Cat-Lips/F00F.Steamworks.NET.git addons/Steamworks.NET"
)
