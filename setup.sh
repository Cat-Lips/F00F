...
externals=(
  ...
  #"https://github.com/LauraWebdev/GodotSteam_CSharpBindings.git addons/godotsteam"
  #"https://github.com/LauraWebdev/GodotSteam_CSharpBindings.git addons/godotsteam_csharpbindings"
)
